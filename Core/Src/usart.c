...
/**
  ******************************************************************************
  * @file    usart.c
  * @brief   This file provides a lightweight USART2 driver for Bluetooth tuning.
  ******************************************************************************
  */
...
void USART2_Write(const uint8_t *data, uint16_t length)
{
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  {
    PID_Debug_RxCpltCallback(usart2_rx_byte);
    HAL_UART_Receive_IT(&huart2, &usart2_rx_byte, 1);
  }
}
